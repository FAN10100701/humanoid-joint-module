/* ============================================================
   ...
   ============================================================ */
var SW_VERSION='robot-3d-v32';           /* 【可调】代码缓存版本号：bump 只清代码/库缓存，模型缓存保留。v31: 3D拆解台弯曲演示崩溃/爆炸位移累加/编码器光路展开/目录排序/右键平移/爆炸取景等10项修复(docs/审计/修复摘要_2026-09-19_3D拆解台.md),须刷新HTML代码缓存 (V2.1.32: 三条链讲授节) */
