 ...
 * provider 二选一:
 *   "twikoo" —— 自托管后端(CloudBase 云函数 / Vercel / Zeabur),envId 为部署后生成的 ID
 *   "valine" —— LeanCloud 存储(国内版免费,纯配置零部署),需要 appId/appKey/serverURLs
 * 切换后无需改动任何页面,刷新即生效。
 * 2026-08-17:Twikoo 云函数已在 CloudBase 部署成功 → provider 切回 twikoo。
 */
window.COMMENTS_CONFIG = {
  ...
  envId: "twikoo-env-d1gjabi5l2e5613b2", /* Twikoo:CloudBase 环境 ID(云函数部署完成) */
