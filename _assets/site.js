...
(function(){
  ...
  S.NAV = [
    { t:"首页",     u:"index.html" },
    { t:"3D解剖",   u:"00_解剖式知识可视化/人形机器人解剖式知识可视化.html" },
    { t:"理论入门", u:"01_第一部分_理论入门/01_整体知识框架_思维导图.html" },
    { t:"硬件基础", u:"02_第二部分_硬件基础/04_硬件设计通用要点_避坑指南.html" },
    { t:"项目实操", u:"03_第三部分_项目实操/06_本次项目核心_Hdrive融合方案完整指南.html" },
    { t:"升级进阶", u:"04_第四部分_升级进阶/09_通信与控制算法升级路线.html" },
    { t:"软件算法", u:"06_第六部分_软件与算法/01_软件学习路线图.html" },
    { t:"前沿知识", u:"07_第七部分_前沿知识库/01_全球人形机器人机型全景.html" },
    { t:"学习工具", u:"08_第八部分_学习工具/01_术语词典.html" }
  ];
  ...
  function injectChrome(){
    ...
    ft.innerHTML = "人形机器人学习站 · 免费开源教学网站 · 软件 + 硬件 + 前沿知识 · "
